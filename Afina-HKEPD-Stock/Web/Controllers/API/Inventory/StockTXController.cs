...
namespace WebApi.Controllers
{
    ...
    public class StockTXController : ApiBaseController
    {
        ...
        public StockTXController(ILogger<StockTXController> logger, InvContext context, IHttpContextAccessor accessor) : base(logger, context, accessor)
        {
            Logger = logger;
            _context = context;
            _accessor = accessor;
        ...
        public async Task<object> GetAsync()
        {
            ...
            var response = new PagedResponse<StockTX>();
        ...
        public async Task<IActionResult> PostStockTakeAsync([FromBody]PostStockTXListRequest requests)
        {
            ...
            try
            {
                foreach (var request in listData)
                {
                    ...
                    entity.Designation = request.Location;
