...
namespace Web.Controllers
{
    public partial class FileManagerController : Controller
    {
        ...
        protected string root = "wwwroot\\Files";
        protected InvContext _context;
        public FileManagerController(IHostingEnvironment hostingEnvironment, InvContext context)
        {
        ...
        protected virtual bool uploadProcess(string filename)
        {
            return true;
        }
    }
