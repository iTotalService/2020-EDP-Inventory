...
namespace WebApi.Controllers
{
    ...
    public class StockController : ApiBaseController
    {
        ...
        public StockController(ILogger<StockController> logger, InvContext context, IHttpContextAccessor accessor) : base(logger,  accessor)
        {
            Logger = logger;
            _accessor = accessor;
        }
        ...
        public async Task<object> GetMobileAsync()
        {
            ...
            try
            {
                ...
                var data = _stockServices.getStockServerTotal();
        ...
        public async Task<object> GetAsync()
        {
            ...
            {
                // Get the "proposed" query from repository
                var data = _stockServices.getRecords();
        ...
        public async Task<IActionResult> GetAsync(long id)
        {
            ...
            try
            {
                ...
                response.Model = _stockServices.getRecords(id);
                NLog.GlobalDiagnosticsContext.Set("Response", JsonConvert.SerializeObject(response));
        ...
        public async Task<IActionResult> PostAsync([FromBody]PostStockRequest request)
        {
            ...
            try
            {
                var existingEntity = _stockServices.getRecords(request.BarCode);
        ...
        public async Task<IActionResult> PutAsync([FromBody]PutStockRequest request)
        {
            ...
            try
            {
                ...
                var entity = _stockServices.getRecords(id);
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(500)]
        public async Task<IActionResult> PostListAsync([FromBody]PostStockListRequest requests)
        {
            LoadUserInfo();
            Logger?.LogDebug("'{0}' has been invoked", nameof(PostAsync));
            ...
            try
            {
                foreach (var request in listData)
                {
                    Stock entity;
                    // Get stock item by id
                    entity = _stockServices.getRecords(request.BarCode);
                    if (entity == null)
                    {
